                ...
                <div className="flex items-center gap-2">
                  ...
                  {userEmail && (
                    user?.estudante?.email_verificado || user?.academia?.email_verificado || user?.admin?.email_verificado ? (
                      ...
                      <button onClick={() => null} disabled={null} className="inline-flex items-center justify-center font-medium gap-2 rounded-lg transition bg-orange-500 text-white shadow-theme-xs hover:bg-orange-600 disabled:bg-orange-300 px-2 py-1.5 text-sm">Verificar e-mail</button>
                    )
                  )}
                </div>
              </div>
