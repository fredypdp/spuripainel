      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            ...
            {User && (
              <div className="order-3 xl:order-2">
                <h4 className="capitalize truncate mb-2 text-lg font-semibold text-center text-gray-800 dark:text-white/90 xl:text-left">{User?.estudante?.nome || User?.academia?.nome || User?.admin?.nome}</h4>
                <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                  <p className="uppercase text-sm text-gray-500 dark:text-gray-400">{User.estudante?.codigo_estudante || User.academia?.codigo_academia || User.admin?.role}</p>
                  <div className="hidden h-3.5 w-px bg-gray-300 dark:bg-gray-700 xl:block"></div>
                  <p className="text-sm text-gray-500 dark:text-gray-400">{User.admin?.email}</p>
                </div>
              </div>
            )}
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
              <a href='https://instagram.com/bilissad' target="_blank"
