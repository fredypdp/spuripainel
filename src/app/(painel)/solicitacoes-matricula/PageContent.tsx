...
export default function PageContent() {
  ...
  const grupos = useMemo(() => {
    const base = (user?.academia?.anos_academicos ?? []).reduce<Record<string, SolicitacaoMatricula[]>>((acc, ano) => {
      acc[ano] = [];
      return acc;
    }, {});
  ...
  }, [items, ordem, user?.academia?.anos_academicos]);
