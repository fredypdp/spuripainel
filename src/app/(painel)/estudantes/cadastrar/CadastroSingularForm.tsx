// src/app/(painel)/estudantes/cadastrar/CadastroSingularForm.tsx
"use client"
...
export default function CadastroSingularForm() {
  ...
  // confirmar `isAcademia`. Este guard trata apenas da janela de hidratação
  // do próprio hook de cookie.
  if (loadingUser || !user) {
    return (
  ...
  // Estado de sucesso
  if (resultado) {
    return <SuccessState resultado={resultado} onCadastrarOutro={limparFormulario} />;
  }
