  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        ...
        {/* ✅ NOVO: Usar ResponsiveTableWrapper em vez do container antigo */}
        <ResponsiveTableWrapper
          className="rounded-xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]"
          showScrollIndicator={true}
        >
          {/* ✅ NOVO: Usar ResponsiveTable em vez de Table */}
          <ResponsiveTable className="w-full">
            {/* ✅ NOVO: Usar ResponsiveTableHeader com sticky opcional */}
            <ResponsiveTableHeader 
            ...
            >
              <ResponsiveTableRow>
                <ResponsiveTableCell 
                  isHeader 
                  className="whitespace-nowrap px-5 py-3 font-medium text-gray-500 text-theme-xs dark:text-gray-400"
                >
                  Nome
                </ResponsiveTableCell>
                <ResponsiveTableCell 
            ...
            {/* Empty state quando não carregado */}
                  ...
                  <ResponsiveTableCell colSpan={9}>
                    <div className="flex flex-col items-center justify-center py-12">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">
                        Clique em "Carregar academias" para visualizar
                      </p>
                    </div>
                  </ResponsiveTableCell>
                </ResponsiveTableRow>
            ...
            {/* Empty state quando carregado mas sem dados */}
            ...
            {!carregandoAcademias && dataAcademias && dataAcademias.total > 0 && (
              <ResponsiveTableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
                {dataAcademias.academias.map((academia) => (
                  <ResponsiveTableRow 
                    key={academia.id} 
                    className="hover:bg-gray-50 dark:hover:bg-white/[0.02]"
                  >
                    <ResponsiveTableCell className="max-w-[200px] capitalize truncate px-5 py-3 text-gray-900 dark:text-white text-theme-sm font-medium">
                      {academia.nome || '-'}
                    </ResponsiveTableCell>
                    <ResponsiveTableCell className="whitespace-nowrap px-5 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                      {academia.codigo_academia || '-'}
                    </ResponsiveTableCell>
                    <ResponsiveTableCell className="whitespace-nowrap capitalize px-5 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                      {academia.type || '-'}
                    </ResponsiveTableCell>
                    <ResponsiveTableCell className="whitespace-nowrap capitalize px-5 py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                    ...
                    <ResponsiveTableCell 
                      align="center"
                      className="whitespace-nowrap px-5 py-3 text-gray-500 text-theme-sm dark:text-gray-400"
                    >
                    ...
                    <ResponsiveTableCell className="whitespace-nowrap px-5 py-3">
                    ...
                    <ResponsiveTableCell className="whitespace-nowrap px-5 py-3">
                      <div className="flex gap-2">
                        <Button size="sm" variant="outline" onClick={() => handleVerDetalhes(academia)}>
                          Ver detalhes
                        </Button>
