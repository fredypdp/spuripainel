...
export default function AvaliacaoFinalRulesSection() {
  ...
  async function submit(e: React.FormEvent) {
    ...
    const payload = { type: type.trim(), nome: nome.trim(), descricao: descricao.trim() || undefined, tipo_ensino: tipoSelecionado, anos_academicos: [...anos], nota_minima_aprovacao: Number(notaMinima), formula: formula.trim(), aplica_se_reprovado_em_type: dependencia || null };
  ...
  const canSubmit = !!type.trim() && !!nome.trim() && !!notaMinima && Number(notaMinima) > 0 && anos.size > 0 && !!formula && categoriasEnvolvidas.length > 0 && !precisaValor;
