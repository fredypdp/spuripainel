...
const SCHOOL_RULE_SECTIONS: SchoolRuleSection[] = [
  ...
  },
  {
    ...
    calculationSteps: [
      "Média do 1.º e 2.º trimestres = (nota do professor + prova trimestral) ÷ 2 em cada trimestre.",
      "Média do 3.º trimestre = (nota do professor + exame final) ÷ 2.",
      "Nota final da matéria = (média do 1.º trimestre + média do 2.º trimestre + média do 3.º trimestre) ÷ 3.",
      "Etapa de recurso: se o estudante teve uma nota abaixo de 5 valores no exame final, a nota final dessa matéria passa a ser a nota do exame de recurso do 3.º trimestre.",
  ...
  },
  {
    ...
    calculationSteps: [
      ...
      "Média do 3.º trimestre = (nota do professor + exame final) ÷ 2.",
      "Nota final da matéria = (média do 1.º trimestre + média do 2.º trimestre + média do 3.º trimestre) ÷ 3.",
      "Etapa de recurso: se o estudante teve uma nota abaixo de 10 valores no exame final, a nota final dessa matéria passa a ser a nota do exame de recurso do 3.º trimestre.",
  ...
  },
  {
    ...
    models: ["liceu", "tecnico"],
    formula: "Exame final = média dos 1.º e 2.º trimestres + 3.º trimestre com exame final; recurso = nota do exame de recurso; nota mínima: 10 valores",
    description: "No 3.º ano do Ensino médio, o sistema calcula a avaliação com exame final usando as médias do 1.º e 2.º trimestres e, no 3.º trimestre, combina a nota do professor com a nota do exame final. Se ainda for necessário, o exame de recurso vale apenas para as matérias que ficaram abaixo da nota mínima.",
    calculationSteps: [
      "Média do 1.º e 2.º trimestres = (nota do professor + prova trimestral) ÷ 2 em cada trimestre.",
      "Média do 3.º trimestre = (nota do professor + exame final) ÷ 2.",
      "Nota final da matéria = (média do 1.º trimestre + média do 2.º trimestre + média do 3.º trimestre) ÷ 3.",
