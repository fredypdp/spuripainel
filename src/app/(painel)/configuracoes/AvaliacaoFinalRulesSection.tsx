...
export default function AvaliacaoFinalRulesSection() {
  ...
  const canSubmit = !!type.trim() && !!nome.trim() && !!notaMinima && Number(notaMinima) > 0 && anos.size > 0 && categoriasEnvolvidas.length > 0 && !!formula && !precisaValor;
